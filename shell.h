 ...
 * @linecount_flag: If active, counts this line of input.
 ...
 * @env_changed: Activated if 'environ' was altered.
 * @status: The return status of the last executed command.
 * @cmd_buf: Address of a pointer to cmd_buf; active if chaining.
 * @cmd_buf_type: Command type: ||, &&, or ;.
 ...
 * @func: The corresponding function for the built-in command.
 */
